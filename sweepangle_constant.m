function SweepAngle = sweepangle_constant(SweepParameters, Epsilon)
...
if RootFwdFilletRatio > 0
    ...
    AddSweep = ((RootFwdFilletRatio - Epsilon)/RootFwdFilletRatio)*RootFwdFilletMaxAdditionalSweep;
    
    AddSweep(Epsilon > RootFwdFilletRatio) = 0;
